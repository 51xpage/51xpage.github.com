...
管理是一个很高大上的词，但是知识管理，我们是在管什么呢？在Windows中，我们给硬盘分区是很平常的，但是Mac就没有这个概念。分区有一个原因是系统盘需要经常重新装，还有一个原因是它成了标配，大家都不知道为啥要这样，但是就是这样，其实也无形中提高了门槛。实际上对于很多人来说，不知不觉就接受了文件要保存这个设定，但是文件保存本身也是一个很专业的事
